...
class ColorLight {
  static const Color primary = Color(0xFF2A50B1);
  static const Color secondary = Color(0xFFFEBE00);
  static const Color background = Color(0xFFF8F8F8);
  static const Color card = Color(0xFFFFFFFF);
  static const Color disabled = Color(0xFF90EE90);
  ...
  static const Color divider = Color(0xFFE7E7E8);
...
class ColorDark {
  static const Color primary = Color(0xFF009946);
